...
class CustomOrder private constructor(
    ...
    class Builder {
        ...
        fun build(): CustomOrder {
            // Calcula o total do pedido a partir dos produtos
            val orderTotal = products.sumByDouble { it.price * it.quantity }
            // Instancia um CustomOrder com os valores fornecidos no Builder
            return CustomOrder(customerName, products, orderTotal, deliveryAddress)
        }
    }
    ...
    fun printReceipt() {
        ...
        println("Total: %.1f".format(this.total)) // Formata o total com uma casas decimais
